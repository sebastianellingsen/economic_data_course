...
- Software skills to work with datasets and organizing data.
...
*In fact, he liked it so much that he wants to construct the same exact chart but beginning in 2003.*
...
- 4 mini projects (and a test project this week)
...
- 4 mini projects: feedback from us in labs and from peers on Eduflow

- and mini project 2: submit on blackboard and receive written feedback from us
...
<!-- knitr::include_graphics("images/visualization_bad.png") -->
<!-- ``` -->
<!-- ] -->
