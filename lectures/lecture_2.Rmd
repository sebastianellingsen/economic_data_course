...
- Tables that measure how the population diminishes population number age increases. 

Two different types of life tables: 

- **Period**: Fixes the age specific mortality rates for one particular year.  

- **Cohort**: Uses the age-specific mortality rate of an actual cohort. 

Notice that cohort life tables contain predictions of future mortality rates for a cohort. 

Important to know which one to use, depends on the question. 
