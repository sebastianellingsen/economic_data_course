...
1. Two of the four mini projects chosen at random (45%) 

2. Two new mini projects (45%) 

3. Additional exercise (10%) 
...
The coursework will be uploaded on **Wednesday December 3**. 

It should be handed in on **Wednesday December 10**. 
...
- Data and measures are well-chosen, clearly explained, and appropriately justified. Explain relevance to the research question/task.

- Visuals are clear and self-explanatory.  Use appropriate chart types (e.g., bar, line, scatter, map) for the data and question.

- Keep descriptions concise and accurate. Avoid speculation, only state what the data supports.

- Strong link between text and visuals. Ensure a single clear narrative — readable and logically ordered.<br><br>

Both your choice of data/measures and your choice of visualisation must be directly informed by the question or task.
