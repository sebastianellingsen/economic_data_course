...
p1 <- ggplot(data = df %>% 
  ...
  xlab("") +
  ylab("GDP per capita") +
  labs(title = "GDP per capita 2022 (national prices)",
...
A common application of $PPS$ measures is to adjust prices for international comparison. 
...
<!-- price in i the same as something costing the second expression in j, fix the price level to country j -->
